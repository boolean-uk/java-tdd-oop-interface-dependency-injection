...
class ScrabbleTest {
    ...
    public void shouldScoreNorwegianLetters() {
        Scrabble scrabble = new Scrabble(new NorwegianAlphabet());
        Assertions.assertEquals(20, scrabble.score("hæipådøra"));
    }

    @Test
    public void shouldScoreRussianLetters() {
        Scrabble scrabble = new Scrabble(new RussianAlphabet());
        Assertions.assertEquals(26, scrabble.score("цшнздв"));
    }
}
